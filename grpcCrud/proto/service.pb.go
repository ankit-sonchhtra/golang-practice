...
var file_service_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0x63, 0x0a, 0x0c, 0x41, 0x72, 0x69, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_service_proto_depIdxs = []int32{
	0, // 0: proto.ArithService.Add:input_type -> proto.Request
	0, // 1: proto.ArithService.Multiply:input_type -> proto.Request
	1, // 2: proto.ArithService.Add:output_type -> proto.Response
	1, // 3: proto.ArithService.Multiply:output_type -> proto.Response
...
func (c *arithServiceClient) Add(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *arithServiceClient) Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (*UnimplementedArithServiceServer) Add(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (*UnimplementedArithServiceServer) Multiply(context.Context, *Request) (*Response, error) {
...
func _ArithService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithServiceServer).Add(ctx, req.(*Request))
	}
...
func _ArithService_Multiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithServiceServer).Multiply(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
